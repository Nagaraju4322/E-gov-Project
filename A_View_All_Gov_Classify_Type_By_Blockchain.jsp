...
<head>
<title>A_View_All_Gov_Classify_Type_By_Blockchain1</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <h2><span class="style31 style46 style12">View All Gov Classify Type By Blockchain !!! </span></h2>
      <br />
      <iframe width="940" height="700" src="A_View_All_Gov_Classify_Type_By_Blockchain1.jsp"></iframe>
      <div class="mainbar">
        <div class="article">
          ...
          <p>&nbsp;</p>
			...
			<p>&nbsp;</p>
              <p align="right"><a href="index.html" class="style10"></a><a href="A_Main.jsp" class="style39">Back</a></p>
            </form>
